...
generate
   ...
   // For $out.
   always_ff @(posedge clk) L0_out_a1[31:0] <= L0_out_a0[31:0];
   ...
   // For random value for missing assignment.
   assign L0_r_val2_low_n1[31:0] = $random() ^ {31'b0, clk};
   always_ff @(posedge clk) L0_r_val2_low_a0[31:0] <= L0_r_val2_low_n1[31:0];

   // For signal $val2_low, which had no assignment.
   // Assign to a random value.
   // verilator lint_save
   // verilator lint_off WIDTH
   assign L0_val2_low_a0[4:0] = L0_r_val2_low_a0;
   // verilator lint_restore
...
generate
   ...
   if (1) begin : DEBUG_SIGS
      ...
      logic [4:0] \@0$val2_low ;
      assign \@0$val2_low = L0_val2_low_a0;
